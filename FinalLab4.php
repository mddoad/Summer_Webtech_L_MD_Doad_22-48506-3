...
$table_creation_query = "CREATE TABLE IF NOT EXISTS doad (
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add'])) {
        ...
        $insert_query = "INSERT INTO doad (name, email, phone) VALUES ('$name', '$email', '$phone')";
    ...
    if (isset($_POST['update'])) {
        ...
        $update_query = "UPDATE doad SET name='$name', email='$email', phone='$phone' WHERE id=$id";
    ...
    if (isset($_POST['delete'])) {
        ...
        $delete_query = "DELETE FROM doad WHERE id=$id";
...
<head>
    ...
    <title>CRUD Operations - DOAD</title>
    <style>
        body {
...
<body>
    ...
    <h1>CRUD Operations on DOAD Table</h1>
